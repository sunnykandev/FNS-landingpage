    ...
    render() {
        return (
            <section className="why-us-wrap section-padding text-white">
                ...
                <SectionTitle Title="Why they choose FantomDomains"  Titlep="Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since" />
